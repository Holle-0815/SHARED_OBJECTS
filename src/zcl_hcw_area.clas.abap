...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_HCW_AREA' ##NO_TEXT.
  data ROOT type ref to ZCL_HCW_ROOT read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_HCW_AREA
    raising
      CX_SHM_INCONSISTENT
...
CLASS ZCL_HCW_AREA IMPLEMENTATION.
